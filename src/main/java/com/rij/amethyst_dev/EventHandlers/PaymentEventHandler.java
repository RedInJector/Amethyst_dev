...
public class PaymentEventHandler implements ApplicationListener<PaymentEvent> {
    ...
    public PaymentEventHandler(UserService userService, ApplicationEventPublisher eventPublisher, DiscordBotService discordBotService, MCServerService mcServerService) {
    ...
    private void Unban(String playerName) {
        ...
        mcServerService.unban(playerName);
        mcServerService.addToWhitelist(playerName);
